...
export function InfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): Info {
    ...
    return {
        ...
        'accessibleTopology': json['AccessibleTopology'] == null ? undefined : ((json['AccessibleTopology'] as Array<any>).map(TopologyFromJSON)),
...
export function InfoToJSON(value?: Info | null): any {
    ...
    return {
        ...
        'AccessibleTopology': value['accessibleTopology'] == null ? undefined : ((value['accessibleTopology'] as Array<any>).map(TopologyToJSON)),
