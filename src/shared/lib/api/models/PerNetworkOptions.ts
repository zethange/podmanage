 ...
 * 
 * @export
 * @interface PerNetworkOptions
 */
export interface PerNetworkOptions {
    /**
...
/**
 * Check if a given object implements the PerNetworkOptions interface.
 */
export function instanceOfPerNetworkOptions(value: object): value is PerNetworkOptions {
    return true;
}

export function PerNetworkOptionsFromJSON(json: any): PerNetworkOptions {
    return PerNetworkOptionsFromJSONTyped(json, false);
}

export function PerNetworkOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PerNetworkOptions {
    if (json == null) {
        return json;
    }
    return {
...
export function PerNetworkOptionsToJSON(value?: PerNetworkOptions | null): any {
    if (value == null) {
        return value;
    }
    return {
