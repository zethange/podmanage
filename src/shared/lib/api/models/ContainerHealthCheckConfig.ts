...
export interface ContainerHealthCheckConfig {
     ...
     * @type {number}
     * @memberof ContainerHealthCheckConfig
     */
...
/**
 * Check if a given object implements the ContainerHealthCheckConfig interface.
 */
export function instanceOfContainerHealthCheckConfig(value: object): value is ContainerHealthCheckConfig {
    return true;
}

export function ContainerHealthCheckConfigFromJSON(json: any): ContainerHealthCheckConfig {
    return ContainerHealthCheckConfigFromJSONTyped(json, false);
}

export function ContainerHealthCheckConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContainerHealthCheckConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function ContainerHealthCheckConfigToJSON(value?: ContainerHealthCheckConfig | null): any {
    if (value == null) {
        return value;
    }
    return {
