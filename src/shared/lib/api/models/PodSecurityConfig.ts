...
/**
 * Check if a given object implements the PodSecurityConfig interface.
 */
export function instanceOfPodSecurityConfig(value: object): value is PodSecurityConfig {
    return true;
}

export function PodSecurityConfigFromJSON(json: any): PodSecurityConfig {
    return PodSecurityConfigFromJSONTyped(json, false);
}

export function PodSecurityConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): PodSecurityConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function PodSecurityConfigToJSON(value?: PodSecurityConfig | null): any {
    if (value == null) {
        return value;
    }
    return {
